...
app_ui <- function() {
  ...
  no_currency_coins <-
    as.list(name_coins[-c(1, 2, 3), ])  #Without USD, EUR and GBP
  #Global parameter
  n <- 24
  ...
  fluidPage(
    ...
    navbarPage(
      ...
      tabPanel(
        ...
        sidebarLayout(
          ...
          sidebarPanel(
            ...
            selectInput(
              inputId = "currency",
              label = "Currency you are interested? ",
              selected = "BTC",
              choices = all_coins
            ),
            ...
            selectInput(
              inputId = "comparison",
              label = "Currency you want to compare? ",
              selected = "USD",
              choices = all_coins
            ),
          ...
          #Main Panel: Plot
          mainPanel(htmlOutput("latestprice"),
      ...
      tabPanel("Minutely Prices",
               ...
               sidebarLayout(
                 ...
                 sidebarPanel(
                   ...
                   selectInput(
                     inputId = "grouping",
                     label = "News count group by what timeframe",
                     selected = "3 hours",
                     choices = c(
                       "Day" = "day",
                       "12 Hours" = "12 hours",
                 ...
                 #Main Panel: Plot
                 mainPanel(withSpinner(plotlyOutput("lastweekPlot")))
      ...
      tabPanel(
        ...
        sidebarLayout(
          ...
          sidebarPanel(
            ...
            selectInput(
              inputId = "cryptoID",
              label = "Enter Cryptocurrency ID",
              selected = "BTC",
              choices = no_currency_coins
            ),
          ...
          mainPanel(htmlOutput("averageprice"),
      ...
      tabPanel(
        "Trading simulation",
        fluidPage(title = "Trading simulation",
